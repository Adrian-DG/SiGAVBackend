	...
	public class MainContext : DbContext
	{
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Rango>().HasData(
					new Rango { Id = 1, Nombre = "GENERAL" },
					new Rango { Id = 2, Nombre = "CORONEL" },
					new Rango { Id = 3, Nombre = "TENIENTE CORONEL" },
					new Rango { Id = 4, Nombre = "MAYOR" },
					new Rango { Id = 5, Nombre = "CAPITAN" },
					new Rango { Id = 6, Nombre = "1ER TENIENTE" },
					new Rango { Id = 7, Nombre = "2DO TENIENTE" },
					new Rango { Id = 8, Nombre = "SARGENTO MAYOR" },
					new Rango { Id = 9, Nombre = "SARGENTO" },
					new Rango { Id = 10, Nombre = "CABO" },
					new Rango { Id = 11, Nombre = "RASO" },
					new Rango { Id = 12, Nombre = "ASIMILADO" },
					new Rango { Id = 13, Nombre = "AGENTE MOPC" }
				);
